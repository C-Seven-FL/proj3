...
##Pmod Header JXADC
set_property -dict { PACKAGE_PIN A14   IOSTANDARD LVCMOS33 } [get_ports { RXIN }]; #IO_L9N_T1_DQS_AD3N_15 Sch=xa_n[1]
set_property -dict { PACKAGE_PIN A13   IOSTANDARD LVCMOS33 } [get_ports { TXOUT }]; #IO_L9P_T1_DQS_AD3P_15 Sch=xa_p[1]
